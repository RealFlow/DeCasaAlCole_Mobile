	...
	showData: function () {
		...
		for (var i = this.current; i < this.filteredData.length; i++){
    		if(i < this.current + this.step) {
	    		...
	    		var html = '<div class="container no-bottom"><div class="dropdown-menu"><a href="#" class="dropdown-deploy"><em class="left-dropdown bg-light"></em><span class="highlight bg-orange"><p style="display: inline; text-transform: lowercase; margin:15px; line-height:40px">' + elem.atimeabreviada + '</p></span><p style="display: inline;">' + '&nbsp;' +  elem.dabreviada +'</p></a><a href="#" class="dropdown-hidden"><em class="left-dropdown bg-light"></em>      </a><a class="dropdown-item-blue bg-light">' + elem.dabreviada + '</a><a class="dropdown-item-yellow bg-light" style="text-transform: lowercase;">' + elem.atime +'</a><a class="dropdown-item-yellow bg-light" style="text-transform: lowercase;">' + elem.adist + '</a><a class="dropdown-item bg-light">' + elem.dgenerica + '</a><a class="dropdown-item bg-light">' + elem.direccion + '</a><a class="dropdown-item bg-light">' + elem.telefono + '</a><a href="map.html" class="dropdown-item bg-light green">' + 'Ir a Mapa' +'</a><div class="dropdown-bottom-border"></div></div></div>';
